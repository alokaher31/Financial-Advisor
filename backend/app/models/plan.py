...
class AssetAllocation(BaseModel):
    ...
    def total_percentage(self) -> float:
        ...
        return self.equity_percentage + self.debt_percentage + self.cash_percentage
...
class MonthlyBreakdown(BaseModel):
    ...
    available_for_savings: float = Field(...)
...
class PlanCreateRequest(BaseModel):
    ...
    goal_ids: List[int] = Field(..., min_length=1, description="List of goal IDs to include in plan")
